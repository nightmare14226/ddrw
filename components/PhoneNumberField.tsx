        ...
        {error ? (
          <>
            <input
              ...
              className="bg-transparent border-b border-red-600 px-[10px] py-[10px] focus:ring-0 focus:outline-transparent focus:outline-none focus:border-b w-full mx-0 focus:ring-offset-0 mt-[40px]"
